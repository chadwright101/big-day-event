...
const Hero = () => {
  return (
    <section className="max-w-[1280px] mx-auto bg-[url(/images/hero-image.jpg)] bg-center bg-cover w-full px-7 py-10 h-[550px] flex justify-center items-end desktop:items-center desktop:justify-start desktop:px-15 desktop:h-[500px]">
