...
export const emailTemplate = ({
  ...
  <head>
    ...
    <title>Big Day Event</title>
  </head>
  <body style="font-family: Arial, sans-serif; line-height: 1.6; margin: 0; padding: 1rem;">
    <table style="width: 100%; background-color: #96AB8F;">
      <tr>
        <td>
          <h1 style="padding: 0 1rem; color: white;">Big Day Event</h1>
        </td>
      </tr>
    </table>
        ...
        <td>
          ...
          ${
            date
              ? `
              <p style="font-size: 1rem; font-weight: 500;">
            Wedding Date: <span style="font-weight: 200; font-style: italic;">${date}</span>
          </p>
          `
              : ""
          }
          ${
            service
              ? `
              <p style="font-size: 1rem; font-weight: 500;">
            Service Type: <span style="font-weight: 200; font-style: italic;">${service}</span>
          </p>
          `
              : ""
          }
